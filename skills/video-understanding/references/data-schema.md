...
```json
{
  ...
  "metrics": {
    "segment_count": 40,
    "segments_per_minute": 9.6,
    "max_gap_seconds": 4.2,
    "target_segments_per_minute": 9.6,
    "min_segments_per_minute": 6.24,
    "max_gap_limit_seconds": 11.0
  },
  "errors": [
...
常见 code：`invalid_time`、`empty_narration`、`time_overlap`、`outside_clip_plan`、`over_budget`、`incomplete_sentence`、`slot_too_short`、`low_density`、`long_gap`。
